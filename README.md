...
## Project Overview
This project reproduces the K-Means clustering algorithm from scratch,
following MacQueen (1967), and extends it with:
- Elbow Method for optimal k selection
- Silhouette Analysis (Rousseeuw, 1987) implemented from scratch
